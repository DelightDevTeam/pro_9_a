...
class AsiaGaming extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:asia-gaming';
    ...
    public function handle()
    {
        ...
        $inputFilePath = base_path('app/Console/Commands/json_data/AsiaGaming.json');
        $outputFilePath = base_path('app/Console/Commands/data/AsiaGamingModify.json');
