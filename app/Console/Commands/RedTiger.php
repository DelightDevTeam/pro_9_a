...
class RedTiger extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:red-tiger';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/RedTiger.json');
        $outputFilePath = base_path('app/Console/Commands/data/RedTigerModify.json');
