...
class SmartSoft extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:smart-soft';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/SmartSoft.json');
        $outputFilePath = base_path('app/Console/Commands/data/SmartSoftModify.json');
